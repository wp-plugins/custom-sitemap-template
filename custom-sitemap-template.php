...
<?php /* START 16-06-15 */
$cst_settings_arr = get_option('cst_settings_arr', null);
...
<?php /* START 16-06-15 */
$lists = $cst_settings_val['sitemap_post_list'];//get_option('sitemap_post_list', true);
$postignore = $cst_settings_val['sitemap_hide_post'];//get_option('sitemap_hide_post', true);
/* END 16-06-15 */
...
<?php /* START 16-06-15 */
$catlists = $cst_settings_val['sitemap_cat_list'];//get_option('sitemap_cat_list', true);
$catignore = $cst_settings_val['sitemap_hide_cat'];//get_option('sitemap_hide_cat', true);
/* END 16-06-15 */
